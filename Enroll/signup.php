  ...
  <body>
    ...
    <main>
      ...
      <section class="login-section">
        <form class="login-div" method="POST" action="signin.php">
          <p class="login-text">Sign Up.</p>
          <label for="emailId">
            Email
            <input type="email" name="email-input" id="emailId" required placeholder="johndoe35@gmail.com" autocomplete="email">
          </label>
          <label for="userName">
            Username
            <input type="text" name="user-name" id="userName" required placeholder="John Doe" autocomplete="username" >
          </label>
